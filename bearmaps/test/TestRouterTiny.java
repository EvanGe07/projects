...
public class TestRouterTiny {
    private static final String OSM_DB_PATH_TINY
        = "../library-su19/data/proj3_xml/tiny-clean.osm.xml";
    ...
    public void test22to66() {
        List<Long> actual
            = Router.shortestPath(graphTiny, 0.2, 38.2, 0.6, 38.6);
    ...
    public void test22to11() {
        List<Long> actual
            = Router.shortestPath(graphTiny, 0.2, 38.2, 0.1, 38.1);
        List<Long> expected = new ArrayList<>();
        expected.add(22L);
        expected.add(11L);
    ...
    public void test41to46() {
        List<Long> actual
            = Router.shortestPath(graphTiny, 0.4, 38.1, 0.4, 38.6);
        List<Long> expected = new ArrayList<>();
        expected.add(41L);
        expected.add(63L);
        expected.add(66L);
    ...
    public void test66to55() {
        List<Long> actual
            = Router.shortestPath(graphTiny, 0.6, 38.6, 0.5, 38.5);
        List<Long> expected = new ArrayList<>();
        expected.add(66L);
        expected.add(63L);
        expected.add(55L);
    ...
    public void testDeadEnd() {
        AStarSolver tester = new AStarSolver<Long>(graphTiny, (long) 11, (long) 88, 20);
        assertEquals(SolverOutcome.UNSOLVABLE, tester.outcome());
    }
}
