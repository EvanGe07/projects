...
public class TestRouter {
    ...
    public void testClosestPoint() throws Exception {
        ...
        for (int i = 0; i < NUM_TESTS; i++) {
            ...
            Long actualStart = graph.closest(params.get("start_lon"), params.get("start_lat"));
            Long expectedStart = expectedResults.get(i).get(0);
            assertEquals("Your results did not match the expected results", expectedStart, actualStart);
        }
    }
    ...
    public void testShortestPath() throws Exception {
        ...
        for (int i = 0; i < NUM_TESTS; i++) {
            System.out.println(String.format("Running test: %d", i));
            Map<String, Double> params = testParams.get(i);
            System.out.println(String.format("From (%f,%f) to (%f,%f)",
