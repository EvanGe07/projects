...
class Utils {
    ...
    /**
     * Sha a file and return the result.
     *
     * @param toSha The file to calculate hashcode
     * @return A string of sha1 result.
     */
    static String sha1File(File toSha) {
        return (sha1(readContents(toSha)));
    }
}
