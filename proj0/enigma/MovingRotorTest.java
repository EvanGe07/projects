...
public class MovingRotorTest {
    ...
    @Test
    public void checkRotorIIBSet() {
        setRotor("II", NAVALA, ""); // Consider trying Rotors besides Rotor I
        rotor.set(1);
        checkRotor("Rotor II set", UPPER_STRING, NAVALB_MAP.get("II"));
    }

    @Test
    public void checkRotorIIZSet() {
        setRotor("II", NAVALA, ""); // Consider trying Rotors besides Rotor I
        rotor.set(25);
